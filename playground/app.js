...
request({
    ...
    json: true
} , function(error, response, body){        //argumetns are : error / response / body
    //console.log(JSON.stringify(body, undefined, 2));
    //console.log(JSON.stringify(response, undefined, 2));    
    //console.log(JSON.stringify(error, undefined, 2));
    console.log('address : ' + body.query.results.channel.title);
    console.log('latitude : ' + body.query.results.channel.item.lat);
    console.log('longtitude : ' + body.query.results.channel.item.long);
